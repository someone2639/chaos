...
static const Lights1 transparent_key_lights = gdSPDefLights1(
    0x03, 0x05, 0x17,
    0x1e, 0x32, 0xe6, 0x28, 0x28, 0x28
);

const Gfx transparent_key_verts[] = {
    gsSPLight(&transparent_key_lights.l, 1),
    gsSPLight(&transparent_key_lights.a, 2),
    gsSPVertex(bowser_key_dl_vertex_group1, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
...
const Gfx transparent_key_dl[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsDPSetEnvColor(255, 255, 255, 120),
    gsSPDisplayList(transparent_key_verts),
