...
const GeoLayout silver_coin_geo[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE(8, geo_switch_anim_state),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver0),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver0),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver1),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver1),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver2),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver2),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver3),
         GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_silver3),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
