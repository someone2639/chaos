...
extern const GeoLayout transparent_bowser_key_geo[];
extern const Gfx bowser_key_dl[];
extern const Gfx transparent_key_dl[];
...
extern const Gfx rainbow_star_dl[];
extern const Gfx rainbow_star_dl_spec[];
extern const GeoLayout star_rainbow_geo[];
...
#include "star_medallion/geo_header.h"
