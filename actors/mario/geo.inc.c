...
const GeoLayout mario_geo_invisible[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_ASM(FALSE, geo_allow_display_held_obj_poser),
      GEO_ASM(0, geo_mirror_mario_backface_culling),
      GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, NULL),
      GEO_OPEN_NODE(),
         GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, NULL),
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 68, -10, -79, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, NULL), // starts sharing solid color of his dl with mario_right_forearm (red)
                     GEO_OPEN_NODE(),
         ...
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ASM(TRUE, geo_allow_display_held_obj_poser),
      GEO_ASM(1, geo_mirror_mario_backface_culling),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout mario_geo[] = {
   GEO_SWITCH_CASE(0, geo_switch_chaos_mario_invisible),
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SCALE(0x00, 16384),
         GEO_OPEN_NODE(),
            GEO_BRANCH(1, mario_geo_invisible),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
