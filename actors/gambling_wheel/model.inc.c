...
static Vtx wedge_6_25_vtx[8] = {
	{{ {-16,  -1, 0}, 0, { 0 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  0,  -1, 0}, 0, {16 << 5, 83 << 5}, { 96,  96,  96, 255} }},
...
static Vtx wedge_12_5_vtx[8] = {
	{{ {-32,  -1, 0}, 0, { 0 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  0,  -1, 0}, 0, {32 << 5, 83 << 5}, { 96,  96,  96, 255} }},
...
static Vtx wedge_18_75_vtx[8] = {
	{{ {-48,  -1, 0}, 0, { 0 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  0,  -1, 0}, 0, {48 << 5, 83 << 5}, { 96,  96,  96, 255} }},
...
static Vtx wedge_25_vtx[8] = {
	{{ {-64,  -1, 0}, 0, { 0 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  0,  -1, 0}, 0, {64 << 5, 83 << 5}, { 96,  96,  96, 255} }},
...
static Vtx border_line_slice_vtx[4] = {
	{{ { -2,  -1, 0}, 0, { 0 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  2,  -1, 0}, 0, { 4 << 5, 83 << 5}, { 96,  96,  96, 255} }},
	{{ {  2,  82, 0}, 0, { 4 << 5,  0 << 5}, {  0,   0,   0, 255} }},
	{{ { -2,  82, 0}, 0, { 0 << 5,  0 << 5}, {  0,   0,   0, 255} }},
};
