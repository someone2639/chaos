...
ALIGNED8 static const Texture wheel_flipper_image[] = {
#include "actors/gambling_wheel/custom_flipper.ia8.preswap.inc.c"
};
...
static Vtx wheel_flipper_vtx[4] = {
	{{ { -4, -13, 0}, 0, { 0 << 5, 32 << 5}, {  0,   0,   0, 255} }},
	{{ {  4, -13, 0}, 0, {16 << 5, 32 << 5}, {  0,   0,   0, 255} }},
	{{ {  4,   3, 0}, 0, {16 << 5,  0 << 5}, {  0,   0,   0, 255} }},
	{{ { -4,   3, 0}, 0, { 0 << 5,  0 << 5}, {  0,   0,   0, 255} }},
};
...
static Vtx wedge_6_25_vtx[8] = {
	{{ {-16,  -1, 0}, 0, { 0 << 5, 83 << 5}, {160, 160, 160, 255} }},
	{{ {  0,  -1, 0}, 0, {16 << 5, 83 << 5}, {160, 160, 160, 255} }},
...
static Vtx wedge_12_5_vtx[8] = {
	{{ {-32,  -1, 0}, 0, { 0 << 5, 83 << 5}, {160, 160, 160, 255} }},
	{{ {  0,  -1, 0}, 0, {32 << 5, 83 << 5}, {160, 160, 160, 255} }},
...
static Vtx wedge_18_75_vtx[8] = {
	{{ {-48,  -1, 0}, 0, { 0 << 5, 83 << 5}, {160, 160, 160, 255} }},
	{{ {  0,  -1, 0}, 0, {48 << 5, 83 << 5}, {160, 160, 160, 255} }},
...
static Vtx wedge_25_vtx[8] = {
	{{ {-64,  -1, 0}, 0, { 0 << 5, 83 << 5}, {160, 160, 160, 255} }},
	{{ {  0,  -1, 0}, 0, {64 << 5, 83 << 5}, {160, 160, 160, 255} }},
...
static Vtx border_peg[4] = {
	{{ { -2,  82, 0}, 0, { 0 << 5,  2 << 5}, { 16,  16,  16, 255} }},
	{{ {  0,  80, 0}, 0, { 2 << 5,  4 << 5}, {160, 160, 160, 255} }},
	{{ {  2,  82, 0}, 0, { 4 << 5,  2 << 5}, {128, 128, 128, 255} }},
	{{ {  0,  84, 0}, 0, { 2 << 5,  0 << 5}, {  0,   0,   0, 255} }},
};

static Vtx border_line_slice_vtx[4] = {
	{{ { -1,  -1, 0}, 0, { 0 << 5, 84 << 5}, {160, 160, 160, 255} }},
	{{ {  1,  -1, 0}, 0, { 2 << 5, 84 << 5}, {160, 160, 160, 255} }},
	{{ {  1,  83, 0}, 0, { 2 << 5,  0 << 5}, {  0,   0,   0, 255} }},
...
Gfx gambling_wheel_dl_wheel_flipper[] = {
    gsDPPipeSync(),
    gsDPLoadTextureBlockS(wheel_flipper_image, G_IM_FMT_IA, G_IM_SIZ_8b, 16, 32, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(wheel_flipper_vtx, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
};

Gfx gambling_wheel_dl_peg[] = {
    gsDPPipeSync(),
    gsSPVertex(border_peg, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
};
