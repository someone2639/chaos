...
#define ACT_GROUND_POUND_JUMP          (0x084 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_SPIN_JUMP                  (0x08F | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
#define ACT_GALAXY_SPIN                (0x090 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_GROUND_POUND_WATER                       (0x0E4 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_ATTACKING)
#define ACT_GROUND_POUND_LAND_WATER                  (0x0E5 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING)
...
#define ACT_MIRACLE_RESPAWN            (0x13E | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
#define ACT_SAFETY_NET_RESPAWN         (0x13F | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
