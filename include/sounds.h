...
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_0   /* 0x04488081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x48, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_1   /* 0x04498081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x49, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_2   /* 0x044A8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4A, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_3   /* 0x044B8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_4   /* 0x044C8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_5   /* 0x044D8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_6   /* 0x044E8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_STUCK_IN_GROUND_7   /* 0x044F8081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x4F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_0     /* 0x04608081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x60, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_0_HPR /* 0x0460C081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x60, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_1     /* 0x04618081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x61, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_2     /* 0x04628081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x62, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_3     /* 0x04638081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x63, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_4     /* 0x04648081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x64, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_5     /* 0x04658081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x65, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_6     /* 0x04668081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x66, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_TERRAIN_HEAVY_LANDING_7     /* 0x04678081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x67, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_ACTION_UNDERWATER_GROUND_POUND                      SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x71, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
/* Custom Betah 1 */
#define SOUND_MARIO_BETA_HOO                     /* 0x24408081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x12, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
/* Custom Betah 2 */
#define SOUND_MARIO_BETA_OU                      /* 0x24408081 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x17, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MENU_STAR_SOUND_LETS_A_GO_FOCUSM   /* 0x7025FF81 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x25, 0xFF, SOUND_DISCRETE)
#define SOUND_MENU_SONIC_LOSE_RINGS              /* 0x70268081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x26, 0xB0, SOUND_DISCRETE)
