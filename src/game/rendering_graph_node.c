...
#ifdef WIDE
        if (widescreenConfig && gCurrLevelNum != 0x01){
...
#else
    halfFov = (gCurGraphNodeCamFrustum->fov / 2.0f + 1.0f) * 32768.0f / 180.0f + 0.5f; // Keep it vanilla-like if not allowing widescreen
#endif
