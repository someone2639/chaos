...
static const struct ChaosPatchSeq chaosSeqArray[] = {
    ...
    {SEQ_CHAOSEVENT_SM3DW_WORLD_BOWSER,    0x58},
    {SEQ_CHAOSEVENT_DPPT_GAME_CORNER,      0x52},
    {SEQ_CHAOSEVENT_MKDS_WALUIGI_PINBALL,  0x64},
    {SEQ_CHAOSEVENT_MP3_GAME_GUY_MINIGAME, 0x6E},
    {SEQ_CHAOSEVENT_OOT_SHOOTING_GALLERY,  0x58},
    {SEQ_CHAOSEVENT_SA_CASINO_PARADISE_1,  0x58},
    {SEQ_CHAOSEVENT_SMB2_BONUS_MINIGAME,   0x4C},
    {SEQ_CHAOSEVENT_SMG2_WARP_PIPE_ROOM,   0x58},
};
...
// NOTE: Main course normal entry warps are duplicated to decrease odds of weird sub-areas (excluding THI 1/2)
...
s32 lvl_set_current_level(UNUSED s16 arg0, s32 levelNum) {
    ...
    chs_collectors_anxiety_load_new_level();
