...
// Movement Modifiers
    ...
    [CHAOS_PATCH_BETA] = {
        ...
        INCOMPATIBLE(CHAOS_PATCH_SUNSHINE_TWIRL, CHAOS_PATCH_MORE_HUD, CHAOS_PATCH_FOCUS_M)
...
// Audio Modifiers
    ...
    [CHAOS_PATCH_SOUND_EFFECT_SHUFFLE] = {
        ...
        INCOMPATIBLE(CHAOS_PATCH_INVERTED_SOUND, CHAOS_PATCH_LUIGI, CHAOS_PATCH_FOCUS_M)
...
// Miscellaneous Modifiers
    ...
    [CHAOS_PATCH_LUIGI] = {
        ...
        INCOMPATIBLE(CHAOS_PATCH_MARIO_INVISIBLE, CHAOS_PATCH_SOUND_EFFECT_SHUFFLE, CHAOS_PATCH_POSER, CHAOS_PATCH_FOCUS_M)
