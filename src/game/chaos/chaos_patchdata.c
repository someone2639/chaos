...
// Star/Save Modifiers
    ...
    [CHAOS_PATCH_COIN_FLIP] = {
        ...
        .shortDescription   = "Flip a coin! If heads, gain a random unobtained star. But if tails, gain a random negative rank 1 patch!",
    },
...
// Health Modifiers
    ...
    [CHAOS_PATCH_TEMPORARY_INVINCIBILITY] = {
        ...
        .shortDescription   = "Mario cannot lose health for 30 seconds upon entering a new level.",
    },
...
// Movement Modifiers
    ...
    [CHAOS_PATCH_CANT_STOP_WONT_STOP] = {
        ...
        .longDescription    = "This will essentially act as if the joystick is always pointed in the held direction at the maximum magnitude. If the joystick is not being held, it will reuse the most recently held direction. Have fun swimming or flying like this!"
    },
    ...
    [CHAOS_PATCH_UNDERWATER_GROUNDPOUND] = {
        ...
        .shortDescription   = "Allows ground pounds while underwater. Get down to deep places with style!",
    },
...
// Object Spawners
    [CHAOS_PATCH_GREEN_DEMON] = {
        ...
        .effectType         = CHAOS_EFFECT_NEGATIVE,
        .severity           = 3,
        .duration           = 1, // Not in Normal Difficulty
        .durationHard       = 1,
...
// Speed Modifiers
    ...
    [CHAOS_PATCH_WALKIES] = {
        ...
        INCOMPATIBLE(CHAOS_PATCH_GREEN_DEMON, CHAOS_PATCH_SPEED_TAX, CHAOS_PATCH_HEALTH_DRAIN, CHAOS_PATCH_COSMIC_CLONES, CHAOS_PATCH_PUSH_BACK, CHAOS_PATCH_STAR_MEDALLION, CHAOS_PATCH_WATER_BOMBS, CHAOS_PATCH_GRAVITY_INCREASE, CHAOS_PATCH_LOWER_TIME_LIMIT, CHAOS_PATCH_SLIPPERY_FLOORS, CHAOS_PATCH_NO_TOLERANCE_FALL_DAMAGE)
...
// Miscellaneous Modifiers
    [CHAOS_PATCH_NO_TOLERANCE_FALL_DAMAGE] = {
            ...
            INCOMPATIBLE(CHAOS_PATCH_NO_FALL_DAMAGE, CHAOS_PATCH_COSMIC_RAYS, CHAOS_PATCH_LETHAL_FALL_DAMAGE, CHAOS_PATCH_ONE_HIT_WONDER, CHAOS_PATCH_LOSEMOVE_LEDGE_GRAB, CHAOS_PATCH_SONIC_SIMULATOR, CHAOS_PATCH_DAMAGE_LOTTERY, CHAOS_PATCH_GREEN_DEMON, CHAOS_PATCH_NOHEAL_COINS, CHAOS_PATCH_PUSH_BACK, CHAOS_PATCH_REMOVE_CAP, CHAOS_PATCH_WALKIES)
