...
// TODO: Make sure star medallions don't get shuffled with Shuffle Objects patch
...
static u8 sm_pss_can_wall_kick(void)           { return !chaos_check_if_patch_active(CHAOS_PATCH_LOSEMOVE_WALL_KICK); }
...
static const struct StarMedallionSpawnLocation starMedallionList_BOB[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -3583, .y =  1392, .z = -2560, .conditionalFunc = NULL                          }, // Above a tree in the fenced area
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  -650, .y =    25, .z =  5625, .conditionalFunc = NULL                          }, // Underneath the bridge near the start
};
static const struct StarMedallionSpawnLocation starMedallionList_WF[]    = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -2495, .y =  2065, .z =  -256, .conditionalFunc = NULL                          }, // At the top of the pole above the wild blue star
...
static const struct StarMedallionSpawnLocation starMedallionList_JRB[] = {
    {.areaNum = 1, .checkpointOnly = FALSE, .x =   659, .y =  3094, .z =  3314, .conditionalFunc = sm_jrb_cannon_pole            }, // Above the tallest blast star pole (cannon involved)
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  7145, .y = -3300, .z =  2128, .conditionalFunc = NULL                          }, // Where the eel normally is on Act 2
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1600, .y = -2437, .z = -5550, .conditionalFunc = NULL                          }, // Above a falling pillar rock in the front of the cave
    {.areaNum = 1, .checkpointOnly = FALSE, .x =    50, .y = -2435, .z = -6600, .conditionalFunc = NULL                          }, // Above a falling pillar rock in the side of the cave
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -2000, .y = -2441, .z = -3500, .conditionalFunc = NULL                          }, // Above a falling pillar rock in the back of the cave
...
static const struct StarMedallionSpawnLocation starMedallionList_CCM[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3300, .y = -1250, .z =  2075, .conditionalFunc = sm_ccm_a1_broken_bridge       }, // In between the broken bridge by the red coin star
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -3748, .y = -3983, .z =  4464, .conditionalFunc = NULL                          }, // Above the tree on the way to Wall Kicks Will Work (cannon involved)
...
static const struct StarMedallionSpawnLocation starMedallionList_BBH[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3350, .y =   250, .z =  1550, .conditionalFunc = NULL                          }, // Inside the scary hole with the boo and red coin room
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  2960, .y =   250, .z =  -775, .conditionalFunc = NULL                          }, // Inside the breakable bridge room, over the bridge
    // Upstairs
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  2866, .y =  1070, .z =  1897, .conditionalFunc = sm_bbh_can_go_upstairs        }, // Over the tilting floor trap
    // Even More Upstairs
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =     0, .y = -2207, .z = -1350, .conditionalFunc = NULL                          }, // Path right of the merry-go-round
...
static const struct StarMedallionSpawnLocation starMedallionList_HMC[] = {
    // Left Side Main Area
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -6550, .y =  1274, .z =  3450, .conditionalFunc = NULL                          }, // Hidden below the long jump spot at the start of the level
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  6600, .y =  -107, .z = -1575, .conditionalFunc = NULL                          }, // In the alcove with no exit, by metal cap box
...
static const struct StarMedallionSpawnLocation starMedallionList_LLL[] = {
    ...
    {.areaNum = 2, .checkpointOnly = TRUE,  .x =  1078, .y =  4222, .z = -2269, .conditionalFunc = NULL                          }, // On top of second to last pole on edge path, by the star
};
static const struct StarMedallionSpawnLocation starMedallionList_SSL[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5989, .y =   624, .z = -4850, .conditionalFunc = NULL                          }, // Above palm tree by cannon bob-omb
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -2875, .y =  1018, .z = -2170, .conditionalFunc = NULL                          }, // On path to top of pyramid by fly guy
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  6450, .y =   614, .z =  2250, .conditionalFunc = NULL                          }, // On top of flat stone platform by shell box
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1792, .y =  1374, .z =   772, .conditionalFunc = NULL                          }, // Above Pillar 1
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1792, .y =  1246, .z = -2556, .conditionalFunc = NULL                          }, // Above Pillar 2
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5885, .y =  1374, .z = -2556, .conditionalFunc = NULL                          }, // Above Pillar 3
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5885, .y =  1374, .z =   772, .conditionalFunc = NULL                          }, // Above Pillar 4
    // Area 2 (checkpoint)
    ...
    {.areaNum = 2, .checkpointOnly = TRUE,  .x = -3362, .y =  1000, .z = -1250, .conditionalFunc = NULL                          }, // On jumping grindel at the bottom
    ...
    {.areaNum = 2, .checkpointOnly = TRUE,  .x = -2450, .y =  2170, .z =   200, .conditionalFunc = NULL                          }, // By rolling spindel
    ...
    {.areaNum = 2, .checkpointOnly = TRUE,  .x =  -870, .y =  4840, .z =     0, .conditionalFunc = NULL                          }, // On jumping grindel at the top
};
...
static const struct StarMedallionSpawnLocation starMedallionList_SL[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1766, .y =  3440, .z =  -942, .conditionalFunc = NULL                          }, // Above tree before penguin bridge
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1200, .y =  3353, .z =  1225, .conditionalFunc = NULL                          }, // Halfway across penguin bridge
    {.areaNum = 1, .checkpointOnly = FALSE, .x =     0, .y =  5488, .z =     0, .conditionalFunc = NULL                          }, // Above tree on top of snowman head in center of the stage
    // Area 2
...
static const struct StarMedallionSpawnLocation starMedallionList_WDW[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -2687, .y =  3132, .z =  3650, .conditionalFunc = NULL                          }, // Below angled slope before cannon
    ...
    // {.areaNum = 1, .checkpointOnly = FALSE, .x = -2200, .y =   434, .z =  1145, .conditionalFunc = NULL                          }, // Hidden inside encased pushable box near the bottom of the stage (TODO: Shine effect needs to be visible through box for this to be fair)
    // {.areaNum = 1, .checkpointOnly = FALSE, .x = -1843, .y =  2354, .z = -3694, .conditionalFunc = NULL                          }, // Hidden inside pushable box near the top of the stage (TODO: Shine effect needs to be visible through box for this to be fair)
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3390, .y =  1975, .z =   384, .conditionalFunc = NULL                          }, // On top of spawn
    // Area 2
...
static const struct StarMedallionSpawnLocation starMedallionList_TTM[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3500, .y = -1250, .z =  3000, .conditionalFunc = NULL                          }, // Over rolling log (after it's been moved as much as it can)
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  4540, .y = -4357, .z =  1060, .conditionalFunc = sm_ttm_a1_can_wall_kick       }, // Gap over a void near the start of the stage (needs wall kicks)
    // Area 2 (checkpoint)
...
static const struct StarMedallionSpawnLocation starMedallionList_THI[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -4400, .y =   300, .z = -2150, .conditionalFunc = NULL                          }, // In bowling ball spawner square thing
    ...
    {.areaNum = 2, .checkpointOnly = FALSE, .x =  1444, .y =   471, .z =   676, .conditionalFunc = NULL                          }, // Above tree by where you'd normally fire cannon to on huge island to get to subarea
    ...
    {.areaNum = 3, .checkpointOnly = FALSE, .x = -1915, .y = -1561, .z = -1100, .conditionalFunc = NULL                          }, // Top of high pillar next to red coin spawn
...
static const struct StarMedallionSpawnLocation starMedallionList_RR[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3554, .y =  4945, .z = -2327, .conditionalFunc = NULL                          }, // Above top of pole on windy ship
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5275, .y =  2196, .z = -6225, .conditionalFunc = NULL                          }, // Inside back corner of big house
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5800, .y = -1706, .z =  5640, .conditionalFunc = NULL                          }, // Lower section of stage, on top of flamethrower after donuts
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  6785, .y = -1221, .z =  6565, .conditionalFunc = NULL                          }, // Back of Tricky Triangles section
};
// TODO: Make sure to ignore spawns inside Bowser fight levels (not tied to a course).
static const struct StarMedallionSpawnLocation starMedallionList_BITDW[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  -204, .y = -2024, .z =  3682, .conditionalFunc = NULL                          }, // Center of rotating platforms near start of stage
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -4600, .y =  1556, .z =  -312, .conditionalFunc = NULL                          }, // Above spike thing on separate platform with amp near center of stage
...
static const struct StarMedallionSpawnLocation starMedallionList_BITFS[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =   614, .y =  4688, .z =    96, .conditionalFunc = NULL                          }, // Above first raisy-lowery pole on third floor, before Bowser entrance
...
static const struct StarMedallionSpawnLocation starMedallionList_BITS[] = {
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -1015, .y = -4445, .z =   625, .conditionalFunc = NULL                          }, // Below tilting bridge near beginning
...
static const struct StarMedallionSpawnLocation starMedallionList_PSS[] = {
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -5894, .y =  6394, .z = -3945, .conditionalFunc = NULL                          }, // Hidden behind camera at spawn
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3172, .y =  7060, .z = -5645, .conditionalFunc = sm_pss_can_wall_kick          }, // Above start of slide
    {.areaNum = 1, .checkpointOnly = FALSE, .x =     0, .y =  -713, .z =  2280, .conditionalFunc = NULL                          }, // Jump where slide opens up, before steep slope with coins
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1866, .y =  3325, .z = -1690, .conditionalFunc = NULL                          }, // Above first gate thing where 1-UP normally is halfway down the slide
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -4741, .y =  -713, .z = -2985, .conditionalFunc = NULL                          }, // Above pole thing near bottom of the slide
};
...
static const struct StarMedallionSpawnLocation starMedallionList_VCUTM[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  1900, .y =  -650, .z = -6250, .conditionalFunc = NULL                          }, // Between first and second set of rotating platforms
...
static const struct StarMedallionSpawnLocation starMedallionList_WMOTR[] = {
    {.areaNum = 1, .checkpointOnly = FALSE, .x = -3290, .y =  3386, .z = -4447, .conditionalFunc = NULL                          }, // Below one of the grabbable vines at top of stage
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =  3996, .y = -1795, .z =  5477, .conditionalFunc = NULL                          }, // Above the grabbable vine at bottom of stage by cannon bob-omb
...
static const struct StarMedallionSpawnLocation starMedallionList_SA[] = {
    ...
    {.areaNum = 1, .checkpointOnly = FALSE, .x =     0, .y =  -325, .z =     0, .conditionalFunc = NULL                          }, // At very top of stage, centered
