...
struct ObjValPtr {
    ...
    /* 0x20 */ s32 flag;       // DECOMP_DO: better name for this? If 0x40000, then `offset` is an offset to a field in `obj`. Otherwise, `obj` is NULL, and `offset` is the address of a variable. 
}; /* sizeof = 0x24 */
