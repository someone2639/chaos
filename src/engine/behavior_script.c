...
static s32 bhv_cmd_spawn_obj(void) {
    ...
    // DECOMP_DO: Does this cmd need renaming? This line is the only difference between this and the above func.
...
static s32 bhv_cmd_drop_to_floor(void) {
    ...
    gCurrentObject->oMoveFlags |= (OBJ_MOVE_ON_GROUND | OBJ_DROPPED_TO_FLOOR);
