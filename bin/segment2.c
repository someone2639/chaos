...
ALIGNED8 static const Texture texture_hud_char_beta_head[] = {
#include "textures/segment2/beta_head.rgba16.inc.c"
};
ALIGNED8 static const Texture texture_hud_char_beta_coin[] = {
#include "textures/segment2/beta_coin.rgba16.inc.c"
};
ALIGNED8 static const Texture texture_hud_char_beta_star[] = {
...
static const Vtx vertex_triangle_centered[] = {
    {{{    -4,     -8,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     4,      0,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    -4,      8,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx dl_draw_triangle_centered[] = {
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetCombineMode(G_CC_FADE, G_CC_FADE),
    gsDPSetRenderMode(G_RM_XLU_SURF, G_RM_XLU_SURF2),
    gsDPSetTextureFilter(G_TF_POINT),
    gsSPVertex(vertex_triangle_centered, 3, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
    gsSPSetGeometryMode(G_LIGHTING),
    gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
Gfx patch_bg_patch_bg_2_i4_aligner[] = {gsSPEndDisplayList()};
u8 patch_bg_patch_bg_2_i4[] = {
#include "textures/segment2/custom_patch_bg_2.i4.inc.c" 
};
...
Vtx patch_bg_s_mesh_s_mesh_vtx_0[4] = {
	{{ {-62, 15, 0}, 0, {-167, 445}, {255, 255, 255, 255} }},
	{{ {-62, -15, 0}, 0, {-805, 2597}, {255, 255, 255, 255} }},
	{{ {62, 15, 0}, 0, {9419, 1571}, {255, 255, 255, 255} }},
	{{ {73, -15, 0}, 0, {9678, 3829}, {255, 255, 255, 255} }},
};

Vtx patch_bg_s_mesh_s_mesh_vtx_1[8] = {
	{{ {-65, -17, 0}, 0, {-1672, 122}, {255, 255, 255, 255} }},
	{{ {-62, -15, 0}, 0, {-1554, 289}, {255, 255, 255, 255} }},
	{{ {-62, 15, 0}, 0, {-1315, 1861}, {255, 255, 255, 255} }},
	{{ {77, -17, 0}, 0, {2201, 622}, {255, 255, 255, 255} }},
	{{ {73, -15, 0}, 0, {2069, 748}, {255, 255, 255, 255} }},
	{{ {64, 17, 0}, 0, {2036, 2678}, {255, 255, 255, 255} }},
	{{ {62, 15, 0}, 0, {1938, 2464}, {255, 255, 255, 255} }},
	{{ {-65, 17, 0}, 0, {-1383, 2004}, {255, 255, 255, 255} }},
};
...
Gfx patch_bg_s_mesh_s_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_4b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0, G_TX_WRAP | G_TX_NOMIRROR, 7, 0),
	gsDPSetTileSize(0, 0, 0, 508, 252),
	gsSPVertex(patch_bg_s_mesh_s_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPVertex(patch_bg_s_mesh_s_mesh_vtx_1 + 0, 8, 0),
...
Gfx star_timer_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 star_timer_rgba16[] = { 
	#include "textures/segment2/star_timer_custom.rgba16.inc.c"
};

Gfx patch_uses_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 patch_uses_rgba16[] = { 
	#include "textures/segment2/patch_uses_custom.rgba16.inc.c"
};

Vtx patch_use_type_mesh_vtx_0[4] = {
...
Gfx star_timer[] = {
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, star_timer_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 1023, 256),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0),
	gsDPSetTileSize(0, 0, 0, 124, 124),
	gsSPVertex(patch_use_type_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};
...
Gfx uses_counter[] = {
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, patch_uses_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 1023, 256),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0),
	gsDPSetTileSize(0, 0, 0, 124, 124),
...
Gfx desc_bg_desc_bg_i8_aligner[] = {gsSPEndDisplayList()};
u8 desc_bg_desc_bg_i8[] = {
	#include "textures/segment2/desc_bg_custom.i8.inc.c"
};
...
Vtx desc_bg_mesh_mesh_vtx_1[8] = {
	...
	{{ {-149, 38, 0}, 0, {-2011, -197}, {CHS_SHD_MAX, CHS_SHD_MAX, CHS_SHD_MAX, 0xFF} }},
	{{ {149, 38, 0}, 0, {2312, 1116}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {146, 36, 0}, 0, {2276, 1133}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {149, -34, 0}, 0, {1997, 2154}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {146, -32, 0}, 0, {1976, 2120}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {-149, -34, 0}, 0, {-2327, 842}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
};
...
Vtx desc_bg_fileselect_mesh_mesh_vtx_0[4] = {
	{{ {-146, 36, 0}, 0, {-3965, -163}, {0xFF, 0xFF, 0xFF, 0xFF} }},
	{{ {-146, -32, 0}, 0, {-4564, 825}, {0xFF, 0xFF, 0xFF, 0xFF} }},
	{{ {146, -32, 0}, 0, {3968, 2120}, {0xFF, 0xFF, 0xFF, 0xFF} }},
	{{ {146, 36, 0}, 0, {4568, 1133}, {0xFF, 0xFF, 0xFF, 0xFF} }},
};

Vtx desc_bg_fileselect_mesh_mesh_vtx_1[8] = {
	{{ {-146, -32, 0}, 0, {-2290, 825}, {0, 0, 127, 0xFF} }},
	{{ {-146, 36, 0}, 0, {-1990, -163}, {0, 0, 127, 0xFF} }},
	{{ {-149, 38, 0}, 0, {-2011, -197}, {0, 0, 127, 0xFF} }},
	{{ {149, 38, 0}, 0, {2312, 1116}, {0, 0, 127, 0xFF} }},
	{{ {146, 36, 0}, 0, {2276, 1133}, {0, 0, 127, 0xFF} }},
	{{ {149, -34, 0}, 0, {1997, 2154}, {0, 0, 127, 0xFF} }},
	{{ {146, -32, 0}, 0, {1976, 2120}, {0, 0, 127, 0xFF} }},
	{{ {-149, -34, 0}, 0, {-2327, 842}, {0, 0, 127, 0xFF} }},
};

Gfx desc_bg_fileselect_mesh_mesh[] = {
	gsDPPipeSync(),
	gsSPLoadGeometryMode(G_CULL_BACK | G_SHADING_SMOOTH),
	gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, PRIMITIVE, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, PRIMITIVE),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_AD_DISABLE | G_CD_MAGICSQ | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_1CYCLE | G_PM_1PRIMITIVE),
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(desc_bg_fileselect_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(desc_bg_fileselect_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Vtx ext_desc_bg_ext_mesh_mesh_vtx_1[8] = {
	...
	{{ {-149, 109, 0}, 0, {-1678, -1294}, {CHS_SHD_MAX, CHS_SHD_MAX, CHS_SHD_MAX, 0xFF} }},
	{{ {149, 109, 0}, 0, {2646, 19}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {146, 107, 0}, 0, {2594, 87}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {149, -109, 0}, 0, {1646, 3310}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {146, -107, 0}, 0, {1641, 3225}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {-149, -109, 0}, 0, {-2678, 1997}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
};
...
Vtx desc_bg_diff_diff_mesh_mesh_vtx_0[4] = {
	{{ {-39, 29, 0}, 0, {3841, -1196}, {255, 255, 255, 255} }},
	{{ {-39, -29, 0}, 0, {3324, -344}, {255, 255, 255, 255} }},
	{{ {29, -29, 0}, 0, {5311, -87}, {255, 255, 255, 255} }},
	{{ {29, 29, 0}, 0, {5828, -938}, {255, 255, 255, 255} }},
};

Vtx desc_bg_diff_diff_mesh_mesh_vtx_1[10] = {
	{{ {29, 29, 0}, 0, {2906, -938}, {0, 0, 127, 255} }},
	{{ {29, -29, 0}, 0, {2648, -87}, {0, 0, 127, 255} }},
	{{ {32, -31, 0}, 0, {2669, -52}, {0, 0, 127, 255} }},
	{{ {32, 31, 0}, 0, {2943, -955}, {0, 0, 127, 255} }},
	{{ {-39, 29, 0}, 0, {1911, -1196}, {0, 0, 127, 255} }},
	{{ {-42, 31, 0}, 0, {1894, -1230}, {0, 0, 127, 255} }},
	{{ {-39, -29, 0}, 0, {1653, -344}, {0, 0, 127, 255} }},
	{{ {-42, -31, 0}, 0, {1620, -328}, {0, 0, 127, 255} }},
	{{ {32, -31, 0}, 0, {2669, -52}, {0, 0, 127, 255} }},
	{{ {-42, -31, 0}, 0, {1620, -328}, {0, 0, 127, 255} }},
};
...
Gfx desc_bg_diff_diff_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(desc_bg_diff_diff_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(desc_bg_diff_diff_mesh_mesh_vtx_1 + 0, 10, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Vtx desc_bg_chal_chal_mesh_mesh_vtx_0[4] = {
	{{ {-39, 29, 0}, 0, {3293, -293}, {255, 255, 255, 255} }},
	{{ {-39, -29, 0}, 0, {2775, 559}, {255, 255, 255, 255} }},
	{{ {29, -29, 0}, 0, {4762, 816}, {255, 255, 255, 255} }},
	{{ {29, 29, 0}, 0, {5281, -36}, {255, 255, 255, 255} }},
};

Vtx desc_bg_chal_chal_mesh_mesh_vtx_1[8] = {
	{{ {-39, -29, 0}, 0, {1379, 559}, {0, 0, 127, 255} }},
	{{ {-39, 29, 0}, 0, {1638, -293}, {0, 0, 127, 255} }},
	{{ {-42, 31, 0}, 0, {1620, -328}, {0, 0, 127, 255} }},
	{{ {32, 31, 0}, 0, {2669, -52}, {0, 0, 127, 255} }},
	{{ {29, 29, 0}, 0, {2632, -36}, {0, 0, 127, 255} }},
	{{ {32, -31, 0}, 0, {2394, 850}, {0, 0, 127, 255} }},
	{{ {29, -29, 0}, 0, {2373, 816}, {0, 0, 127, 255} }},
	{{ {-42, -31, 0}, 0, {1346, 575}, {0, 0, 127, 255} }},
};
...
Gfx desc_bg_chal_chal_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(desc_bg_chal_chal_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(desc_bg_chal_chal_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Vtx desc_bg_start_start_mesh_mesh_vtx_0[4] = {
	{{ {-39, 8, 0}, 0, {2757, 588}, {255, 255, 255, 255} }},
	{{ {-39, -8, 0}, 0, {2598, 849}, {255, 255, 255, 255} }},
	{{ {29, -8, 0}, 0, {4585, 1109}, {255, 255, 255, 255} }},
	{{ {29, 8, 0}, 0, {4731, 867}, {255, 255, 255, 255} }},
};

Vtx desc_bg_start_start_mesh_mesh_vtx_1[8] = {
	{{ {-39, -8, 0}, 0, {1290, 849}, {0, 0, 127, 255} }},
	{{ {-39, 8, 0}, 0, {1370, 588}, {0, 0, 127, 255} }},
	{{ {-42, 10, 0}, 0, {1353, 551}, {0, 0, 127, 255} }},
	{{ {32, 10, 0}, 0, {2394, 850}, {0, 0, 127, 255} }},
	{{ {29, 8, 0}, 0, {2358, 867}, {0, 0, 127, 255} }},
	{{ {32, -10, 0}, 0, {2305, 1143}, {0, 0, 127, 255} }},
	{{ {29, -8, 0}, 0, {2284, 1109}, {0, 0, 127, 255} }},
	{{ {-42, -10, 0}, 0, {1252, 862}, {0, 0, 127, 255} }},
};
...
Gfx desc_bg_start_start_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(desc_bg_start_start_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(desc_bg_start_start_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Vtx chstut_bg_mesh_mesh_vtx_0[4] = {
	{{ {-146, -60, 0}, 0, {-3965, -163}, {CHS_SHD_MAX, CHS_SHD_MAX, CHS_SHD_MAX, 0xFF} }},
	{{ {-146, -99, 0}, 0, {-4564, 258}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {146, -99, 0}, 0, {3968, 1548}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {146, -60, 0}, 0, {4568, 1133}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
};

Vtx chstut_bg_mesh_mesh_vtx_1[8] = {
	{{ {-146, -99, 0}, 0, {1, 1}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {-146, -60, 0}, 0, {1, 2}, {CHS_SHD_MAX, CHS_SHD_MAX, CHS_SHD_MAX, 0xFF} }},
	{{ {-149, -58, 0}, 0, {0, 2}, {CHS_SHD_MAX, CHS_SHD_MAX, CHS_SHD_MAX, 0xFF} }},
	{{ {149, -58, 0}, 0, {3, 3}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {146, -60, 0}, 0, {2, 3}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
	{{ {149, -101, 0}, 0, {3, 0}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {146, -99, 0}, 0, {2, 1}, {CHS_SHD_MIN, CHS_SHD_MIN, CHS_SHD_MIN, 0xFF} }},
	{{ {-149, -101, 0}, 0, {0, 0}, {CHS_SHD_MED, CHS_SHD_MED, CHS_SHD_MED, 0xFF} }},
};
...
Gfx chstut_bg_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(chstut_bg_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(SHADE, 0, PRIMITIVE, 0, 0, 0, 0, 1, SHADE, 0, PRIMITIVE, 0, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(chstut_bg_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Vtx opt_bg_opt_mesh_mesh_vtx_0[4] = {
	{{ {-34, 44, 0}, 0, {3572, -535}, {255, 255, 255, 255} }},
	{{ {-34, -44, 0}, 0, {2788, 756}, {255, 255, 255, 255} }},
	{{ {34, -44, 0}, 0, {4778, 1058}, {255, 255, 255, 255} }},
	{{ {34, 44, 0}, 0, {5562, -233}, {255, 255, 255, 255} }},
};

Vtx opt_bg_opt_mesh_mesh_vtx_1[8] = {
	{{ {-34, -44, 0}, 0, {1386, 756}, {0, 0, 127, 255} }},
	{{ {-34, 44, 0}, 0, {1778, -535}, {0, 0, 127, 255} }},
	{{ {-37, 46, 0}, 0, {1757, -569}, {0, 0, 127, 255} }},
	{{ {37, 46, 0}, 0, {2809, -249}, {0, 0, 127, 255} }},
	{{ {34, 44, 0}, 0, {2773, -233}, {0, 0, 127, 255} }},
	{{ {37, -46, 0}, 0, {2402, 1092}, {0, 0, 127, 255} }},
	{{ {34, -44, 0}, 0, {2381, 1058}, {0, 0, 127, 255} }},
	{{ {-37, -46, 0}, 0, {1349, 773}, {0, 0, 127, 255} }},
};
...
Gfx opt_bg_opt_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(opt_bg_opt_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(opt_bg_opt_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Vtx act_desc_bg_act_desc_mesh_mesh_vtx_0[4] = {
	{{ {-66, 74, 0}, 0, {-1195, -515}, {255, 255, 255, 255} }},
	{{ {-66, -74, 0}, 0, {-2689, 1946}, {255, 255, 255, 255} }},
	{{ {66, -74, 0}, 0, {1163, 2531}, {255, 255, 255, 255} }},
	{{ {66, 74, 0}, 0, {2657, 70}, {255, 255, 255, 255} }},
};

Vtx act_desc_bg_act_desc_mesh_mesh_vtx_1[8] = {
	{{ {-66, -74, 0}, 0, {-1353, 1946}, {0, 0, 127, 255} }},
	{{ {-66, 74, 0}, 0, {-606, -515}, {0, 0, 127, 255} }},
	{{ {-68, 76, 0}, 0, {-639, -508}, {0, 0, 127, 255} }},
	{{ {68, 76, 0}, 0, {1343, 100}, {0, 0, 127, 255} }},
	{{ {66, 74, 0}, 0, {1321, 70}, {0, 0, 127, 255} }},
	{{ {68, -76, 0}, 0, {609, 2518}, {0, 0, 127, 255} }},
	{{ {66, -74, 0}, 0, {574, 2531}, {0, 0, 127, 255} }},
	{{ {-68, -76, 0}, 0, {-1377, 1922}, {0, 0, 127, 255} }},
};
...
Gfx act_desc_bg_act_desc_mesh_mesh[] = {
	...
	gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_8b, 8, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(act_desc_bg_act_desc_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, 1, 0, 0, 0, PRIMITIVE, 0, 0, 0, 1),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 3, G_AC_NONE | G_ZS_PIXEL),
	gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
	gsSPVertex(act_desc_bg_act_desc_mesh_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP2Triangles(1, 4, 3, 0, 4, 5, 3, 0),
	gsSP2Triangles(4, 6, 5, 0, 6, 7, 5, 0),
	gsSP2Triangles(6, 0, 7, 0, 0, 2, 7, 0),
...
Gfx hand_closed_hand_closed_ia8_aligner[] = {gsSPEndDisplayList()};
u8 hand_closed_hand_closed_ia8[] = {
	#include "textures/segment2/hand_closed_custom.ia8.inc.c"
};

Vtx hand_Mesh_mesh_vtx_0[4] = {
	{{ {-14, -14, 0}, 0, {0, 1024}, {255, 255, 255, 255} }},
	{{ {14, -14, 0}, 0, {1024, 1024}, {255, 255, 255, 255} }},
	{{ {14, 14, 0}, 0, {1024, 0}, {255, 255, 255, 255} }},
...
Gfx curtain_curtain1_ia16_aligner[] = {gsSPEndDisplayList()};
u8 curtain_curtain1_ia16[] = {
	#include "textures/segment2/curtain1_custom.ia16.inc.c"
};

Gfx curtain_curtain2_ia16_aligner[] = {gsSPEndDisplayList()};
u8 curtain_curtain2_ia16[] = {
	#include "textures/segment2/curtain2_custom.ia16.inc.c"
};

Gfx curtain_curtain3_ia16_aligner[] = {gsSPEndDisplayList()};
u8 curtain_curtain3_ia16[] = {
	#include "textures/segment2/curtain3_custom.ia16.inc.c"
};

Gfx curtain_curtain4_ia16_aligner[] = {gsSPEndDisplayList()};
u8 curtain_curtain4_ia16[] = { 
	#include "textures/segment2/curtain4_custom.ia16.inc.c"
};

Gfx curtain_curtain5_ia16_aligner[] = {gsSPEndDisplayList()};
u8 curtain_curtain5_ia16[] = {
	#include "textures/segment2/curtain5_custom.ia16.inc.c"
};

Vtx curtain_Plane_mesh_vtx_0[4] = {
	{{ {-160, -151, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {-96, -151, 0}, 0, {2032, 1008}, {255, 255, 255, 255} }},
	{{ {-96, 120, 0}, 0, {2032, -16}, {255, 255, 255, 255} }},
	{{ {-160, 120, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
};

Vtx curtain_Plane_mesh_vtx_1[4] = {
	{{ {-96, -151, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {-32, -151, 0}, 0, {2032, 1008}, {255, 255, 255, 255} }},
	{{ {-32, 120, 0}, 0, {2032, -16}, {255, 255, 255, 255} }},
	{{ {-96, 120, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
};

Vtx curtain_Plane_mesh_vtx_2[4] = {
	{{ {-32, -151, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {32, -151, 0}, 0, {2032, 1008}, {255, 255, 255, 255} }},
	{{ {32, 120, 0}, 0, {2032, -16}, {255, 255, 255, 255} }},
	{{ {-32, 120, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
};

Vtx curtain_Plane_mesh_vtx_3[4] = {
	{{ {32, -151, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {96, -151, 0}, 0, {2032, 1008}, {255, 255, 255, 255} }},
	{{ {96, 120, 0}, 0, {2032, -16}, {255, 255, 255, 255} }},
	{{ {32, 120, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
...
Vtx curtain_Plane_mesh_vtx_4[4] = {
	{{ {96, -151, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {160, -151, 0}, 0, {2032, 1008}, {255, 255, 255, 255} }},
	{{ {160, 120, 0}, 0, {2032, -16}, {255, 255, 255, 255} }},
	{{ {96, 120, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
};
...
Gfx curtain_Plane_mesh[] = {
	...
	gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_AD_DISABLE | G_CD_MAGICSQ | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_1CYCLE | G_PM_1PRIMITIVE),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_AC_NONE | G_ZS_PIXEL | AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM) | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetPrimColor(0, 0, 255, 1, 0, 255),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b_LOAD_BLOCK, 1, curtain_curtain1_ia16),
	...
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsSPVertex(curtain_Plane_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b_LOAD_BLOCK, 1, curtain_curtain2_ia16),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsSPVertex(curtain_Plane_mesh_vtx_1 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b_LOAD_BLOCK, 1, curtain_curtain3_ia16),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsSPVertex(curtain_Plane_mesh_vtx_2 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b_LOAD_BLOCK, 1, curtain_curtain4_ia16),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsSPVertex(curtain_Plane_mesh_vtx_3 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b_LOAD_BLOCK, 1, curtain_curtain5_ia16),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsSPVertex(curtain_Plane_mesh_vtx_4 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_CD_MAGICSQ | G_AD_DISABLE | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_1CYCLE | G_PM_1PRIMITIVE),
...
Gfx select_patch_text_selectpatch_ia4_aligner[] = {gsSPEndDisplayList()};
u8 select_patch_text_selectpatch_ia4[] = {
	#include "textures/segment2/selectpatch_custom.ia4.inc.c"
};

Gfx select_patch_text_selectpatch_event_1_ia4_aligner[] = {gsSPEndDisplayList()};
u8 select_patch_text_selectpatch_event_1_ia4[] = {
	#include "textures/segment2/selectpatch_event_1_custom.ia4.inc.c"
};

Gfx select_patch_text_selectpatch_event_2_ia4_aligner[] = {gsSPEndDisplayList()};
u8 select_patch_text_selectpatch_event_2_ia4[] = {
	#include "textures/segment2/selectpatch_event_2_custom.ia4.inc.c"
};

Gfx select_patch_text_selectpatch_event_3_ia4_aligner[] = {gsSPEndDisplayList()};
u8 select_patch_text_selectpatch_event_3_ia4[] = {
	#include "textures/segment2/selectpatch_event_3_custom.ia4.inc.c"
};

Vtx select_patch_text_mesh_mesh_vtx_0[4] = {
	{{ {-85, -14, 0}, 0, {-16, 1008}, {255, 255, 255, 255} }},
	{{ {85, -14, 0}, 0, {8176, 1008}, {255, 255, 255, 255} }},
	{{ {85, 14, 0}, 0, {8176, -16}, {255, 255, 255, 255} }},
	{{ {-85, 14, 0}, 0, {-16, -16}, {255, 255, 255, 255} }},
};
...
Gfx select_patch_text_mesh_mesh[] = {
	...
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_AC_NONE | G_ZS_PIXEL | AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM) | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, select_patch_text_selectpatch_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_4b, 16, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 8, 0),
	gsDPSetTileSize(0, 0, 0, 1020, 124),
	gsSPVertex(select_patch_text_mesh_mesh_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsDPPipeSync(),
	gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_CD_MAGICSQ | G_AD_DISABLE | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_1CYCLE | G_PM_1PRIMITIVE),
...
Gfx select_patch_text_event_1[] = {
	...
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_AC_NONE | G_ZS_PIXEL | AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM) | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, select_patch_text_selectpatch_event_1_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_4b, 16, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 8, 0),
	gsDPSetTileSize(0, 0, 0, 1020, 124),
...
Gfx select_patch_text_event_2[] = {
	...
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_AC_NONE | G_ZS_PIXEL | AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM) | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, select_patch_text_selectpatch_event_2_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_4b, 16, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 8, 0),
	gsDPSetTileSize(0, 0, 0, 1020, 124),
...
Gfx select_patch_text_event_3[] = {
	...
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_AC_NONE | G_ZS_PIXEL | AA_EN | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | ALPHA_CVG_SEL | GBL_c1(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM) | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, select_patch_text_selectpatch_event_3_ia4),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_4b, 16, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0, G_TX_CLAMP | G_TX_NOMIRROR, 8, 0),
	gsDPSetTileSize(0, 0, 0, 1020, 124),
...
ALIGNED8 u8 texture_icon_a_button_down[] = {
#include "textures/segment2/a_button_down_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_b_button[] = {
#include "textures/segment2/b_button_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_b_button_down[] = {
#include "textures/segment2/b_button_down_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_start_button[] = {
#include "textures/segment2/start_button_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_start_button_down[] = {
#include "textures/segment2/start_button_down_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_l_trig[] = {
#include "textures/segment2/l_trig_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_l_trig_down[] = {
#include "textures/segment2/l_trig_down_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_r_trig[] = {
#include "textures/segment2/r_trig_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_r_trig_down[] = {
#include "textures/segment2/r_trig_down_custom.rgba16.inc.c"
};

ALIGNED8 u8 texture_icon_z_trig[] = {
#include "textures/segment2/z_trig_custom.rgba16.inc.c"
};
