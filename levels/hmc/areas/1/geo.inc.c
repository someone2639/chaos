...
const GeoLayout hmc_geo_000B90[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_CAMERA_45_DEG_COLLISION(CAMERA_MODE_FREE_ROAM, FALSE, 0, 2000, 6000, 0, 0, 0, geo_camera_main), // No collision, maze is super disorienting (also hanging looks bad)
            GEO_OPEN_NODE(),
