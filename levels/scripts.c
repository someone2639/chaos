...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_KAIZO_BLOCK, kaizo_block_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_ALWAYS_VISIBLE,    mario_geo_always_visible),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_INERT_STAR_TRANSPARENT,  inert_star_transparent_geo),
