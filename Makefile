...
SRC_DIRS += src src/boot src/game src/game/chaos src/game/chaos/patch_behaviors src/engine src/audio src/menu src/buffers actors levels bin data assets asm lib sound
